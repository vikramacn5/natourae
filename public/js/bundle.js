...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFyazQiLCJhIjoiY2t0MTVma2c0MDc3djJucjJyYmY2M2x2bSJ9.de0t3ixNhUuXNOok-SovUA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mark4/ckt16tqra0q3o18pbnej8kjg1',
    scrollZoom: false // center: [-79.38394097321783, 43.6504618654015],
    // zoom: 10,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated sccessfully!"));
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51JZVWRSIt9BxtkVNLVLnFWIQvufPk0ABuEqLsNVRhGJNkhjOPubYAXzvKYz7HESFjbA9NlZtSXSwCTOLgnPV7dlG002m4VVRtB');
            _context.next = 4;
          ...
          case 10:
            _context.prev = 10;
            _context.t0 = _context["catch"](0);
            console.log(_context.t0), (0, _alerts.showAlert)('error', _context.t0);
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordCurrent, passwordUpdated, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordUpdated = document.getElementById('password').value;
